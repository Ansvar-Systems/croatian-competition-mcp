...
[![npm version](https://badge.fury.io/js/%40ansvar%2Fcroatian-competition-mcp.svg)](https://www.npmjs.com/package/@ansvar/croatian-competition-mcp)
...
**Endpoint:** `https://mcp.ansvar.eu/croatian-competition/mcp`

| Client | How to Connect |
|--------|---------------|
| **Claude.ai** | Settings > Connectors > Add Integration > paste URL |
| **Claude Code** | `claude mcp add croatian-competition-mcp --transport http https://mcp.ansvar.eu/croatian-competition/mcp` |
...
```json
{
  "mcpServers": {
    "croatian-competition-mcp": {
      "type": "url",
      "url": "https://mcp.ansvar.eu/croatian-competition/mcp"
    }
  }
}
```
...
```bash
npx @ansvar/croatian-competition-mcp
```
...
```json
{
  "mcpServers": {
    "croatian-competition-mcp": {
      "command": "npx",
      "args": ["-y", "@ansvar/croatian-competition-mcp"]
    }
  }
}
```
