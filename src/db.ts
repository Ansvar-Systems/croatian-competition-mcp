/**
 * SQLite database access layer for the AZTN (Croatian Competition Agency — Agencija za zaštitu tržišnog natjecanja) MCP server.
 *
 * Schema:
 *   - decisions    — AZTN (Croatian Competition Agency — Agencija za zaštitu tržišnog natjecanja) enforcement decisions (abuse of dominance, cartels, sector inquiries)
